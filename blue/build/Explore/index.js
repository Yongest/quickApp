...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/Explore/index.ux?uxType=page");
/******/ })
/************************************************************************/
/******/ ({

/***/ "./node_modules/hap-toolkit/packager/lib/dsl/ux/loader/json-loader.js!./node_modules/hap-toolkit/packager/lib/dsl/ux/loader/style-loader.js?index=0&type=style!./node_modules/hap-toolkit/packager/lib/dsl/ux/loader/fragment-loader.js?index=0&type=style!./src/Explore/index.ux?uxType=page":
/*!****************************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/hap-toolkit/packager/lib/dsl/ux/loader/json-loader.js!./node_modules/hap-toolkit/packager/lib/dsl/ux/loader/style-loader.js?index=0&type=style!./node_modules/hap-toolkit/packager/lib/dsl/ux/loader/fragment-loader.js?index=0&type=style!./src/Explore/index.ux?uxType=page ***!
  \****************************************************************************************************************************************************************************************************************************************************************************************************/
...
/***/ "./node_modules/hap-toolkit/packager/lib/dsl/ux/loader/json-loader.js!./node_modules/hap-toolkit/packager/lib/dsl/ux/loader/template-loader.js!./node_modules/hap-toolkit/packager/lib/dsl/ux/loader/fragment-loader.js?index=0&type=template!./src/Explore/index.ux?uxType=page&":
/*!****************************************************************************************************************************************************************************************************************************************************************************************!*\
  !*** ./node_modules/hap-toolkit/packager/lib/dsl/ux/loader/json-loader.js!./node_modules/hap-toolkit/packager/lib/dsl/ux/loader/template-loader.js!./node_modules/hap-toolkit/packager/lib/dsl/ux/loader/fragment-loader.js?index=0&type=template!./src/Explore/index.ux?uxType=page& ***!
  \****************************************************************************************************************************************************************************************************************************************************************************************/
/*! no static exports found */
  ...
  "children": [
    {
      "type": "tabs",
      "attr": {
        "index": function () {return this.currentTabIndex}
      },
      "events": {
        "change": "onTabChange"
      },
          ...
          "children": [
            {
              ...
              "classList": function () {return ['tab-bar-item', this.currentTabIndex===this.$idx?'active':'']},
          ...
          "children": [
            {
              ...
              "children": [
                ...
                },
                {
                  ...
                  "shown": function () {return this.currentTabIndex===this.$idx},
                  "events": {
                  ...
                  "children": [
                    {
                      ...
                      "repeat": {
                        "exp": function () {return this.$item.shops},
                        "value": "s"
                      },
                      "events": {
                        "click": function (evt) {this.onNavigateTo(this.s.id,evt)}
                      },
                      "children": [
                        {
                          "type": "image",
                          "attr": {
                            "src": function () {return this.s.images[0]}
                          },
                          "classList": [
                            "image"
                          ]
                          ...
                          "children": [
                            {
                              "type": "text",
                              "attr": {
                                "value": function () {return this.s.name}
                              },
                              "classList": [
                                "name"
                              ]
                            },
                            {
                              "type": "text",
                              "attr": {
                                "value": function () {return '' + '电话：' + (this.s.phone||'暂无')}
                              },
                              "classList": [
                                "phone"
                              ]
                            },
                            {
                              "type": "text",
                              "attr": {
                                "value": function () {return '' + '地址：' + (this.s.address)}
                              },
                              "classList": [
                                "address"
                              ]
                            },
                            {
                              "type": "text",
                              "attr": {
                                "value": function () {return '' + '营业时间：' + (this.s.businessHours)}
                              },
                              "classList": [
                                "hours"
                              ]
                      ...
                      "children": [
                        {
                          ...
                          "attr": {
                            "type": "circular",
                            "show": function () {return !this.$item.noMore}
                          }
                        },
                        {
                          "type": "text",
...
var _default = {
  ...
  onInit: function onInit() {
    ...
    this.$app.fetchCategories().then(function (data) {
      ...
      var i = data.find(function (i) {
        return i.id === id;
      });
      _this.currentTabIndex = data.indexOf(i);
    });
  },
  ...
  loadMore: function loadMore() {
    ...
    this.isLoading = true;
    var item = Object.assign({}, this.categories[this.currentTabIndex]);
    item.currentPage = item.currentPage || 0;
    this.$app.fetchShops(item.id, ++item.currentPage, item.query).then(function (data) {
      ...
      _this2.categories.splice(_this2.currentTabIndex, 1, item);
...
/***/ "./src/Explore/index.ux?uxType=page":
/*!******************************************!*\
  !*** ./src/Explore/index.ux?uxType=page ***!
  \******************************************/
/*! no static exports found */
